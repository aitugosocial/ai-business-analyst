"""add more profiles to the user table

Revision ID: 2df5553a7024
Revises: 643ed82b1407
Create Date: 2026-07-28 22:35:41.477960
...
revision: str = '2df5553a7024'
down_revision: Union[str, Sequence[str], None] = '643ed82b1407'
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('pinned_profile_post_ids', sa.JSON(), nullable=True))
    op.add_column('users', sa.Column('hide_public_metrics', sa.Boolean(), nullable=True))
    op.add_column('users', sa.Column('expertise', sa.JSON(), nullable=True))
    op.add_column('users', sa.Column('open_to', sa.JSON(), nullable=True))
    op.add_column('users', sa.Column('recent_wins', sa.JSON(), nullable=True))
    op.add_column('users', sa.Column('current_goal', sa.Text(), nullable=True))
...
def downgrade() -> None:
    ...
    op.drop_column('users', 'current_goal')
    op.drop_column('users', 'recent_wins')
    op.drop_column('users', 'open_to')
    op.drop_column('users', 'expertise')
    op.drop_column('users', 'hide_public_metrics')
    op.drop_column('users', 'pinned_profile_post_ids')
