"""add ai takeaways decision to the community discussion table

Revision ID: 0ca6335e5b80
Revises: c53498022896
Create Date: 2026-07-26 21:48:11.284254
...
revision: str = '0ca6335e5b80'
down_revision: Union[str, Sequence[str], None] = 'c53498022896'
...
def upgrade() -> None:
    ...
    op.drop_constraint(op.f('fk_commissions_payout'), 'commissions', type_='foreignkey')
    op.drop_index(op.f('idx_community_activities_user'), table_name='community_activities')
    op.add_column('community_discussions', sa.Column('ai_takeaways', sa.JSON(), nullable=True))
    ...
    op.alter_column('users', 'is_partner',
...
def downgrade() -> None:
    ...
    op.drop_column('community_discussions', 'ai_takeaways')
    op.create_index(op.f('idx_community_activities_user'), 'community_activities', ['user_id'], unique=False)
    op.create_foreign_key(op.f('fk_commissions_payout'), 'commissions', 'payouts', ['payout_id'], ['id'])
