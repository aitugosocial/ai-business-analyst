"""add location and venture_stage to user table

Revision ID: fe5967720e5b
Revises: 2df5553a7024
Create Date: 2026-07-30 03:54:02.983211
...
revision: str = 'fe5967720e5b'
down_revision: Union[str, Sequence[str], None] = '2df5553a7024'
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('venture_stage', sa.String(length=100), nullable=True))
...
def downgrade() -> None:
    ...
    op.drop_column('users', 'venture_stage')
