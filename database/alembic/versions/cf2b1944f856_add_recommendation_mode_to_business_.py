...
def upgrade() -> None:
    ...
    existing_tables = sa.inspect(connection).get_table_names()
    if 'security_metrics_summary' not in existing_tables:
...
def downgrade() -> None:
    ...
    connection = op.get_bind()
    if 'security_metrics_summary' in sa.inspect(connection).get_table_names():
